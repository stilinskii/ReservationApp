...
public class MainMenu {
	...
	public int createReservation(int reservation_id,String reservation_date,String reservation_time,int seat,String name, String phone, int rest_id) {
		return reserDAO.insertReservation(reservation_id,reservation_date,reservation_time,seat,name,phone,rest_id);
	}
	
	//발급번호로 예약 조회
	public String searchReservation(int reservation_id) {
		try {
			return rs.findReservationById(reservation_id).get().toString();
